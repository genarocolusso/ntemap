...
<div class="container text-center">  
  <h1 style="color: #fff; text-shadow: 1px 1px 9px #000">
    ...
    Polo - <?=$value['name']?></h1>
    <h5 class=""> Polo <?php if($value['ativo']==1){echo "<span class='ativocard'>Ativo</span>";}else{echo "<span class='inativocard'>Inativo</span>";}?>: 
  ...
  <div class="container text-center">
   ...
   <?php
    ...
    foreach ($infocontato as $key => $value) {
      ...
      <br>
      <a href="<?=base_url()?>" class="center-block" style="width: 220px;"><div class="btn btn-info btn-lg"><i class="fa fa-map-o"></i> Voltar para o mapa</div></a>
    </div>
  </div>
